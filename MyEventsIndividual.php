...
if(isset($_GET['del'])){
    ...
    if($conn->query($sql))
        header("Location: MyEventsIndividual.php");
    else{
        echo $conn->error;
        die();
    }
...
<div id="nav">
    ...
    <ul id="menu">
        ...
        <li> <a href="HomeIndividual.php"> Events</a></li>
        <li> <a href="MyEventsIndividual.php"> My Events</a></li>
        <li> <a href="ProfileIndividual.php"> Profile</a></li>
            ...
            <tr>
                ...
                <td>
                    <div class="registrarse">
                        <a href="MyEventsIndividual.php?del=<?php echo $event[0] ?>" class="myButton1">Delete</a>
                    </div>
                </td>
            </tr>
        <?php } ?>
